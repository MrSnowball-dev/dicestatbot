...
if ($user_id == '795449748' && $dice !== 'dice_empty') {
	...
	if ($chat_type == 'private') {
		...
		if ($member['result']['status'] == 'creator' || $member['result']['status'] == 'administrator') {
			...
			$tournament_keyboard = ['inline_keyboard' => [
				...
				// ['text' => '⚽', 'callback_data' => 'init_football_tournament']
				]
			]];
...
if ($message == '/mystats' || $message == '/mystats@dicestatbot') {
	...
	$user_stat_switcher_keyboard = ['inline_keyboard' => [
		[['text' => '● 🎲 Stats ●', 'callback_data' => 'get_user_dice'], ['text' => '🎯 Stats', 'callback_data' => 'get_user_darts'], ['text' => '🏀 Stats', 'callback_data' => 'get_user_basket'], ['text' => '⚽ WIP', 'callback_data' => 'get_user_football']]
	]];
...
switch ($callback_data[0]) {
	...
	case 'get_user_dice':
		...
		$user_stat_switcher_keyboard = ['inline_keyboard' => [
			[['text' => '● 🎲 Stats ●', 'callback_data' => 'get_user_dice'], ['text' => '🎯 Stats', 'callback_data' => 'get_user_darts'], ['text' => '🏀 Stats', 'callback_data' => 'get_user_basket'], ['text' => '⚽ Stats', 'callback_data' => 'get_user_football']]
		]];
